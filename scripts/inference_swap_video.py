...
# load safety model (optional - can be disabled if network issues)
# safety_model_id = "CompVis/stable-diffusion-safety-checker"
# safety_feature_extractor = AutoFeatureExtractor.from_pretrained(safety_model_id)
# safety_checker = StableDiffusionSafetyChecker.from_pretrained(safety_model_id)

# Disable safety checker for now due to network issues
...
def check_safety(x_image):
    # Skip safety check if safety checker is disabled
    if safety_checker is None or safety_feature_extractor is None:
        print("Safety checker disabled - skipping safety check")
