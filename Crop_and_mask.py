...
def crop_and_align_face(target_files):
    ...
    xy_sigma = 0
    use_fa = False
    use_insightface = True  # Enable InsightFace antelopev2
    
    print('Aligning images')
    crops, orig_images, quads = crop_faces(image_size, target_files, scale, center_sigma=center_sigma, xy_sigma=xy_sigma, use_fa=use_fa, use_insightface=use_insightface)
...
def crop_and_align_face_img(frame):
    ...
    print('Aligning images')
    crops, orig_images, quads = crop_faces_from_image(image_size, frame, scale, center_sigma=center_sigma, xy_sigma=xy_sigma, use_fa=use_fa, use_insightface=use_insightface)
